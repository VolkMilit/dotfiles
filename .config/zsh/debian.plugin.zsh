...
# commands using sudo #######
    ...
    alias update='sudo aptitude update && sudo apt-get upgrade'
    alias adu='sudo $apt_pref update && sudo $apt_pref dist-upgrade'
    alias afu='sudo apt-file update'
    alias ag='sudo $apt_pref upgrade'
    alias i='sudo aptitude -R install'
    alias p='sudo aptitude purge'
    alias pr='aptitude search $1 -F %p|xargs sudo aptitude remove'
    alias apt-clear='sudo apt-get purge `deborphan | xargs`'
